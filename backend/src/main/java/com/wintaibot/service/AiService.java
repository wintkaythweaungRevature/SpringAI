...
public class AiService {
    ...
    public Map<String, Object> analyzePdf(MultipartFile file, String userPrompt) throws Exception {
        ...
        String aiPrompt = "You are a data extraction assistant. Analyze the following document and return ONLY a valid minified JSON object.\n"
                + "Structure:\n"
                + "{\n"
                + "  \"document_type\": \"<Invoice|Resume|Contract|Report|Financial|Legal|Medical|Academic|Other>\",\n"
                + "  \"summary\": \"2-3 sentence summary\",\n"
                + "  \"key_metrics\": [{\"label\": \"<metric name>\", \"value\": \"<value>\"}],\n"
                ...
                + "}\n"
                + "Rules: key_metrics must have 3-6 important numbers/stats from the document. action_items are concrete next steps or tasks found in the document. entities extract all named people, organizations, dates, and monetary amounts.\n"
