...
const PLANS = [
  {
    ...
    features: [
      ...
      { text: 'AI Captions & Hashtags', included: true },
      { text: 'Content Calendar', included: true },
      { text: 'Video Publisher', included: true },
      { text: 'Image Generator', included: true },
      { text: 'Link-in-Bio page', included: true },
      { text: 'DocuWizard & Resume tools', included: true },
      { text: 'EchoScribe transcription', included: false },
      { text: 'Messages & Auto Reply', included: false },
      { text: 'Growth Planner & Deep Analytics', included: false },
      { text: 'Social AI Chat', included: false },
    ],
  },
  {
    id: 'PRO',
    ...
    features: [
      ...
      { text: 'Social AI Chat', included: true },
      { text: 'Priority processing', included: false },
      { text: 'Video trimming tool', included: false },
    ],
  },
  {
    id: 'GROWTH',
