...
export const metadata: Metadata = {
  title: 'Refund Policy',
  description:
    'W!ntAi Refund Policy. Subscriptions, Stripe billing, cancellations, and how to request a refund.',
};
    ...
    <div style={styles.page}>
      ...
      <main style={styles.main}>
        ...
        <p style={styles.p}>
          ...
          our{' '}
          <Link href="/terms-of-service" style={{ color: '#2563eb', fontWeight: 600 }}>
            Terms of Service
          </Link>
          .
        </p>
